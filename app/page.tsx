        ...
        return (
          ...
          >
            ...
            <div className="flex">
              ...
              />
              <select
                className="ml-4 bg-gray-100 hover:bg-gray-200 font-medium rounded-lg text-sm px-3 text-center inline-flex items-center"
                name="question type"
              ...
              >
                ...
                <option value="dropdown" key="dropdown">
                  Dropdown
                </option>
                <option value="checkboxes" key="checkboxes">
                  Checkboxes
                </option>
              </select>
            </div>
